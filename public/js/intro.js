...
class IntroScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.titleText = this.add.text(400, 80, 'LITTLE SHOP OF', {
            fontSize: '48px',
            fontFamily: 'Arial',
            color: '#ffffff',
            fontStyle: 'bold',
        ...
        this.chaosText = this.add.text(400, 140, 'CHAOS', {
            fontSize: '72px',
            fontFamily: 'Arial',
            color: '#ff4400',
            fontStyle: 'bold',
    ...
    createFireEffect() {
        ...
        letterPositions.forEach((pos, letterIndex) => {
            for (let i = 0; i < 15; i++) { // 15 fire sprites per letter
                ...
                console.log(`Created fire sprite ${letterIndex}-${i} at ${pos.x}, ${pos.y + 40}`);
            }
        });
